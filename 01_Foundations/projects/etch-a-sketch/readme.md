...
- Put grid squares inside a **container** div — static and can be written in HTML file.
...
To learn how to use it, check this [MDN docs article about the opacity CSS property](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/opacity).
